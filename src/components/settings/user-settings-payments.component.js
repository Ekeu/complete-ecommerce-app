            ...
            {card.lastFour ? (
              <>
                ...
                <div className="mt-4 sm:mt-0 sm:ml-6 sm:flex-shrink-0">
                  <button
                    type="button"
                    className="inline-flex items-center px-4 py-2 border border-blue-gray-300 shadow-sm font-medium font-hind rounded-md text-blue-gray-700 bg-white hover:bg-blue-gray-50 focus:outline-none sm:text-sm"
                  >
                    Remove
                  </button>
                </div>
